...
![AOKI overview](/_static/aoki.png)
*Fig. 1: AOKI overview*
...
where:
- `IDevID-Subject-serialNumber` is the `SerialNumber` name attribute in
...
protocol agreed upon by the Device and Owner Service.

#### Protocol description

The initial step is the automatic discovery of the Owner
