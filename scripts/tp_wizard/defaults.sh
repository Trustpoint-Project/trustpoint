...
DEF_TP_ENABLE_PROMETHEUS_METRICS="${TP_ENABLE_PROMETHEUS_METRICS:-true}"
...
TRUSTPOINT_METRICS_SCHEME="${TRUSTPOINT_METRICS_SCHEME:-https}"
TRUSTPOINT_METRICS_TARGET="${TRUSTPOINT_METRICS_TARGET:-trustpoint.local:443}"
TRUSTPOINT_METRICS_PATH="${TRUSTPOINT_METRICS_PATH:-/prometheus/metrics}"
TRUSTPOINT_METRICS_TLS_INSECURE_SKIP_VERIFY="${TRUSTPOINT_METRICS_TLS_INSECURE_SKIP_VERIFY:-true}"
