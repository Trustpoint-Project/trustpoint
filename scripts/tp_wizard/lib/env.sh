...
write_runtime_env() {
  local soft_hsm_enabled=0
  state_has softhsm && soft_hsm_enabled=1
  ...
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_ENABLED "$soft_hsm_enabled"
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_TOKEN_LABEL "$LOCAL_HSM_TOKEN_LABEL"
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_PROFILE_NAME "$LOCAL_HSM_PROFILE_NAME"
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_MODULE_PATH "$LOCAL_HSM_CONTAINER_MODULE_PATH"
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_USER_PIN_FILE "$LOCAL_HSM_CONTAINER_CONFIG_DIR/user-pin.txt"
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_CONFIG_ENV_VAR SOFTHSM2_CONF
  env_set "$ENV_OVERLAY" TRUSTPOINT_LOCAL_HSM_SOFTHSM2_CONF "$LOCAL_HSM_CONTAINER_SOFTHSM2_CONF"
