...
class TrustpointLoginViewTest(TestCase):
    ...
    def test_get_docker_wizard_completed(self, mock_get_state: Mock) -> None:
    ...
    def test_get_docker_wizard_not_completed(self, mock_redirect: Mock, mock_get_state: Mock) -> None:
    ...
    def test_post_non_docker_environment(self, mock_super_post: Mock) -> None:
        ...
        request = self.factory.post(self.login_url, {'username': 'testuser', 'password': 'testpass123'})
        request.user = Mock()
    ...
    @patch('users.views.SetupWizardState.get_current_state')
    @patch('users.views.LoginView.post')
    def test_post_docker_wizard_completed(self, mock_super_post: Mock, mock_get_state: Mock) -> None:
    ...
    @patch('users.views.SetupWizardState.get_current_state')
    @patch('users.views.StartupWizardRedirect.redirect_by_state')
    def test_post_docker_wizard_not_completed(self, mock_redirect: Mock, mock_get_state: Mock) -> None:
    ...
    def test_get_clears_messages(self, mock_get_messages: Mock, mock_get_state: Mock) -> None:
    ...
    @patch('users.views.messages.get_messages')
    @patch('users.views.LoginView.post')
    def test_post_clears_messages(self, mock_super_post: Mock, mock_get_messages: Mock, mock_get_state: Mock) -> None:
    ...
    @patch('users.views.SetupWizardState.get_current_state')
    @patch('users.views.StartupWizardRedirect.redirect_by_state')
    def test_get_wizard_state_setup_hsm(self, mock_redirect: Mock, mock_get_state: Mock) -> None:
    ...
    @patch('users.views.SetupWizardState.get_current_state')
    @patch('users.views.StartupWizardRedirect.redirect_by_state')
    def test_post_wizard_state_setup_hsm(self, mock_redirect: Mock, mock_get_state: Mock) -> None:
