...
class ManualIssuanceMethod(IntEnum):
    """Origin of a credential issued through the manual workflow."""

    TRUSTPOINT_GENERATED = 0
    EXTERNAL_CSR = 1
...
class BaseCertificateRequestContext(BaseRequestContext):
    ...
    # CSR-backed requests retain the external public key and requested data.
    csr_strict: bool = False
...
class BaseCredentialRequestContext(BaseCertificateRequestContext):
    ...
    manual_issuance_method: int | None = None
