...
class CmpSharedSecretAuthentication(AuthenticationComponent, CmpAuthenticationBase, LoggerMixin):
    ...
    def authenticate(self, context: RequestContext) -> None:
        ...
        try:
            ...
            context.response_hmac = hmac_obj
...
class CmpSignatureBasedInitializationAuthentication(AuthenticationComponent, CmpAuthenticationBase, LoggerMixin):
