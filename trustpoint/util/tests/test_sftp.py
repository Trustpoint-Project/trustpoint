...
class TestSftpClient:
    ...
    def test_connect_sftp_password_auth_success(
        self, mock_sftp_from_transport: Mock, mock_transport_class: Mock
    ) -> None:
    ...
    @patch('util.sftp.paramiko.Transport')
    @patch('util.sftp.paramiko.SFTPClient.from_transport')
    def test_test_connection_success(self, mock_sftp_from_transport: Mock, mock_transport_class: Mock) -> None:
    ...
    def test_upload_file_success(
        self, mock_sftp_from_transport: Mock, mock_transport_class: Mock, tmp_path: Path
    ) -> None:
