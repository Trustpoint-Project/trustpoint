...
class TestGetCertificateName:
    ...
    def test_get_name_from_san_dns(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_dns=['device1.example.com', 'device2.example.com']
        )
    ...
    def test_get_name_from_san_uri(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_uri=['https://device.example.com', 'https://other.example.com']
        )
    ...
    def test_get_name_from_aoki_dev_owner(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_uri=['dev-owner:SN123456.example.com']
        )
    ...
    def test_cn_takes_priority_over_san(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name='cn-device.example.com',
            san_dns=['san-device.example.com']
        )
    ...
    def test_san_dns_priority_over_uri(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_dns=['dns-device.example.com'],
            san_uri=['https://uri-device.example.com']
        )
    ...
    def test_empty_cn_falls_back_to_san(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_dns=['fallback-device.example.com']
        )
    ...
    def test_multiple_san_entries(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_dns=['first.example.com', 'second.example.com', 'third.example.com']
        )
    ...
    def test_aoki_dev_owner_with_complex_format(self) -> None:
        ...
        cert = self._create_test_cert(
            common_name=None,
            san_uri=['dev-owner:ABC-123-XYZ-789.manufacturer.example.com']
        )
