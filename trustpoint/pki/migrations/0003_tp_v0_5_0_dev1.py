    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remote_host', models.CharField(blank=True, default='', help_text='The hostname or IP address of the remote CA server', max_length=253, verbose_name='Remote Host')),
                ('remote_port', models.PositiveIntegerField(blank=True, help_text='The port number of the remote CA server', null=True, verbose_name='Remote Port')),
