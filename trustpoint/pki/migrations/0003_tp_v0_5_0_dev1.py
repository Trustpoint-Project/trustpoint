...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, help_text='The truststore containing the full certificate chain for this DevOwnerID.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owner_credential', to='pki.truststoremodel', verbose_name='Chain Truststore'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='est_username',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='No-onboarding configuration used for remote CA enrollment.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='owner_credentials', to='onboarding.noonboardingconfigmodel', verbose_name='No Onboarding Config'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
        ...
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_path',
            field=models.CharField(blank=True, default='', help_text='The path on the remote CA endpoint.', max_length=255, verbose_name='Remote Path'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_port',
