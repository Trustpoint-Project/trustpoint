# Generated by Django 5.2.8 on 2026-01-19 14:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_type', models.IntegerField(blank=True, choices=[(-1, 'Keyless CA'), (0, 'Auto-Generated Root'), (1, 'Auto-Generated'), (2, 'Local-Unprotected'), (3, 'Local-PKCS11'), (4, 'Remote-EST'), (5, 'Remote-CMP')], help_text='Type of CA - null for keyless CAs', null=True, verbose_name='CA Type')),
        ...
        migrations.AddConstraint(
            model_name='camodel',
            constraint=models.CheckConstraint(condition=models.Q(models.Q(('ca_type__isnull', True), ('certificate__isnull', False), ('credential__isnull', True)), models.Q(('ca_type__isnull', False), ('certificate__isnull', True), ('credential__isnull', False)), _connector='OR'), name='exactly_one_ca_mode', violation_error_message='CA must be either keyless (certificate only) or issuing (with credential)'),
        ),
    ]
