...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='est_username',
            field=models.CharField(blank=True, default='', help_text='Username for EST authentication when enrolling from a remote CA.', max_length=128, verbose_name='EST Username'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='key_type',
            field=models.CharField(blank=True, default='ECC-SECP256R1', help_text='Cryptographic key type used for all DevOwnerID key pairs (e.g. RSA-2048, ECC-SECP256R1).', max_length=32, verbose_name='Key Type'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(choices=[(0, 'Local'), (1, 'Remote EST'), (2, 'Remote CMP'), (3, 'Remote EST (Onboarding)')], default=0, help_text='How the DevOwnerID certificate is acquired.', verbose_name='Credential Type'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_host',
            field=models.CharField(blank=True, default='', help_text='The hostname or IP address of the remote CA used to enroll this DevOwnerID.', max_length=253, verbose_name='Remote Host'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_path',
            field=models.CharField(blank=True, default='', help_text='The path on the remote CA endpoint (DevOwnerID enrollment).', max_length=255, verbose_name='Remote Path'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_path_domain_credential',
            field=models.CharField(blank=True, default='', help_text='The EST path used to obtain the domain credential during onboarding (e.g. /.well-known/est/simpleenroll). Only relevant for EST onboarding.', max_length=255, verbose_name='Remote Path (Domain Credential)'),
        ),
        migrations.AddField(
            model_name='ownercredentialmodel',
            name='remote_port',
            field=models.PositiveIntegerField(blank=True, help_text='The port number of the remote CA.', null=True, verbose_name='Remote Port'),
        ),
        migrations.AlterField(
            model_name='certificatemodel',
            name='spki_ec_curve_oid',
            field=models.CharField(choices=[('', 'None'), ('1.2.840.10045.3.1.1', 'Secp192R1'), ('1.3.132.0.33', 'Secp224R1'), ('1.3.132.0.10', 'Secp256K1'), ('1.2.840.10045.3.1.7', 'Secp256R1'), ('1.3.132.0.34', 'Secp384R1'), ('1.3.132.0.35', 'Secp521R1'), ('1.3.36.3.3.2.8.1.1.7', 'Brainpoolp256R1'), ('1.3.36.3.3.2.8.1.1.11', 'Brainpoolp384R1'), ('1.3.36.3.3.2.8.1.1.13', 'Brainpoolp512R1')], default='', editable=False, max_length=256, verbose_name='Public Key Curve OID (ECC)'),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_credential_type', models.IntegerField(choices=[(0, 'Domain Credential'), (2, 'DevOwnerID')], verbose_name='Credential Type')),
