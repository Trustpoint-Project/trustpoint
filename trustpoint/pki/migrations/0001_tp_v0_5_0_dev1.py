    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_key', util.encrypted_fields.EncryptedCharField(blank=True, default='', max_length=116633, verbose_name='Private key (PEM)')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crl_number', models.PositiveIntegerField(default=0, verbose_name='CRL Number')),
        ...
        migrations.AddField(
            ...
            name='issuing_ca',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='domains', to='pki.issuingcamodel', verbose_name='Issuing CA'),
        ),
        migrations.AddField(
