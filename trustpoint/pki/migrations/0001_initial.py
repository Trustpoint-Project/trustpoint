    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature_algorithm_oid', models.CharField(choices=[('1.2.840.113549.1.1.4', '1.2.840.113549.1.1.4'), ('1.2.840.113549.1.1.5', '1.2.840.113549.1.1.5'), ('1.3.14.3.2.29', '1.3.14.3.2.29'), ('1.2.840.113549.1.1.11', '1.2.840.113549.1.1.11'), ('1.2.840.113549.1.1.12', '1.2.840.113549.1.1.12'), ('1.2.840.113549.1.1.13', '1.2.840.113549.1.1.13'), ('2.16.840.1.101.3.4.3.13', '2.16.840.1.101.3.4.3.13'), ('2.16.840.1.101.3.4.3.14', '2.16.840.1.101.3.4.3.14'), ('2.16.840.1.101.3.4.3.15', '2.16.840.1.101.3.4.3.15'), ('2.16.840.1.101.3.4.3.16', '2.16.840.1.101.3.4.3.16'), ('1.2.840.10045.4.1', '1.2.840.10045.4.1'), ('1.2.840.10045.4.3.1', '1.2.840.10045.4.3.1'), ('1.2.840.10045.4.3.2', '1.2.840.10045.4.3.2'), ('1.2.840.10045.4.3.3', '1.2.840.10045.4.3.3'), ('1.2.840.10045.4.3.4', '1.2.840.10045.4.3.4'), ('2.16.840.1.101.3.4.3.9', '2.16.840.1.101.3.4.3.9'), ('2.16.840.1.101.3.4.3.10', '2.16.840.1.101.3.4.3.10'), ('2.16.840.1.101.3.4.3.11', '2.16.840.1.101.3.4.3.11'), ('2.16.840.1.101.3.4.3.12', '2.16.840.1.101.3.4.3.12'), ('1.2.840.113533.7.66.13', '1.2.840.113533.7.66.13')], editable=False, max_length=256, verbose_name='Signature Algorithm OID')),
                ...
                ('spki_algorithm_oid', models.CharField(choices=[('NONE', 'None'), ('1.2.840.10045.2.1', '1.2.840.10045.2.1'), ('1.2.840.113549.1.1.1', '1.2.840.113549.1.1.1')], editable=False, max_length=256, verbose_name='Public Key Algorithm OID')),
                ...
                ('spki_ec_curve_oid', models.CharField(choices=[('None', 'None'), ('1.2.840.10045.3.1.1', '1.2.840.10045.3.1.1'), ('1.3.132.0.33', '1.3.132.0.33'), ('1.3.132.0.10', '1.3.132.0.10'), ('1.2.840.10045.3.1.7', '1.2.840.10045.3.1.7'), ('1.3.132.0.34', '1.3.132.0.34'), ('1.3.132.0.35', '1.3.132.0.35'), ('1.3.36.3.3.2.8.1.1.7', '1.3.36.3.3.2.8.1.1.7'), ('1.3.36.3.3.2.8.1.1.11', '1.3.36.3.3.2.8.1.1.11'), ('1.3.36.3.3.2.8.1.1.13', '1.3.36.3.3.2.8.1.1.13'), ('1.3.132.0.1', '1.3.132.0.1'), ('1.3.132.0.15', '1.3.132.0.15'), ('1.3.132.0.26', '1.3.132.0.26'), ('1.3.132.0.27', '1.3.132.0.27'), ('1.3.132.0.16', '1.3.132.0.16'), ('1.3.132.0.17', '1.3.132.0.17'), ('1.3.132.0.36', '1.3.132.0.36'), ('1.3.132.0.37', '1.3.132.0.37'), ('1.3.132.0.38', '1.3.132.0.38'), ('1.3.132.0.39', '1.3.132.0.39')], default=None, editable=False, max_length=256, verbose_name='Public Key Curve OID (ECC)')),
            ...
            bases=(trustpoint.views.base.LoggerMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='TrustpointTlsServerCredentialModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('private_key_pem', models.CharField(editable=False, max_length=65536, verbose_name='Private Key (PEM)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('credential', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pki.trustpointtlsservercredentialmodel')),
            ],
        ),
        migrations.CreateModel(
