...
-----END CERTIFICATE-----"""
    ...
    def test_serialize_multiple_truststores(self):
        ...
        TruststoreModel.objects.create(unique_name='truststore-1', intended_usage=TruststoreModel.IntendedUsage.IDEVID)
        TruststoreModel.objects.create(unique_name='truststore-2', intended_usage=TruststoreModel.IntendedUsage.TLS)
