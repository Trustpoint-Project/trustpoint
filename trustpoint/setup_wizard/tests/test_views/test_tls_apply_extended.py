...
class TestTlsServerCredentialApplyFormValid:
    ...
    @patch('setup_wizard.views.execute_shell_script')
    @patch.object(SetupWizardTlsServerCredentialApplyView, '_write_pem_files')
    def test_form_valid_config_not_found(self, mock_write_pem, mock_script, mock_first, mock_get_state):
    ...
    @patch('setup_wizard.views.KeyStorageConfig.get_config')
    @patch.object(SetupWizardTlsServerCredentialApplyView, '_write_pem_files')
    def test_form_valid_script_error(self, mock_write_pem, mock_get_config, mock_script, mock_first, mock_get_state):
    ...
    @patch('setup_wizard.views.KeyStorageConfig.get_config')
    @patch.object(SetupWizardTlsServerCredentialApplyView, '_write_pem_files')
    def test_form_valid_file_not_found(self, mock_write_pem, mock_get_config, mock_script, mock_first, mock_get_state):
    ...
    @patch('setup_wizard.views.KeyStorageConfig.get_config')
    @patch.object(SetupWizardTlsServerCredentialApplyView, '_write_pem_files')
    def test_form_valid_unexpected_exception(self, mock_write_pem, mock_get_config, mock_first, mock_get_state):
