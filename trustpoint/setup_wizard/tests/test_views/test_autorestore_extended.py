...
class TestBackupAutoRestorePasswordViewFormValid:
    ...
    def test_form_valid_success(
        self, mock_deactivate, mock_extract_tls, mock_handle_recovery, mock_script
    ):
    ...
    @patch.object(BackupAutoRestorePasswordView, 'handle_backup_password_recovery')
    @patch.object(BackupAutoRestorePasswordView, '_extract_tls_certificates')
    def test_form_valid_tls_extraction_failure(
        self, mock_extract_tls, mock_handle_recovery, mock_script
    ):
    ...
    @patch.object(BackupAutoRestorePasswordView, 'handle_backup_password_recovery')
    @patch.object(BackupAutoRestorePasswordView, '_extract_tls_certificates')
    def test_form_valid_script_called_process_error(
        self, mock_extract_tls, mock_handle_recovery, mock_script
    ):
    ...
    @patch.object(BackupAutoRestorePasswordView, 'handle_backup_password_recovery')
    @patch.object(BackupAutoRestorePasswordView, '_extract_tls_certificates')
    def test_form_valid_script_file_not_found(
        self, mock_extract_tls, mock_handle_recovery, mock_script
    ):
