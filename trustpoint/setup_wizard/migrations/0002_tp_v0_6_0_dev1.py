    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fresh_install_pkcs11_config_path', models.TextField(blank=True, default='', help_text='Optional PKCS#11 provider configuration file staged during the fresh-install wizard.')),
