    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bootstrap_active_flow', models.CharField(blank=True, choices=[('fresh_install', 'Fresh Install'), ('restore_backup', 'Restore Backup'), ('connect_existing', 'Connect Existing')], default='', help_text='Bootstrap flow currently being worked on.', max_length=32)),
                ('bootstrap_current_step', models.CharField(blank=True, default='', help_text='Current step name within the active bootstrap flow.', max_length=64)),
                ...
                ('restore_backup_archive_path', models.TextField(blank=True, default='', help_text='Bootstrap-staged restore archive path.')),
                ('restore_backup_archive_original_name', models.CharField(blank=True, default='', help_text='Original uploaded backup archive filename.', max_length=255)),
                ('restore_backup_import_submitted', models.BooleanField(default=False, help_text='Whether the restore backup import step was submitted.')),
                ('restore_backup_restored_at', models.DateTimeField(blank=True, help_text='Timestamp when the staged backup archive was restored into the target database.', null=True)),
                ('restore_backup_restore_error', models.TextField(blank=True, default='', help_text='Last restore error captured while importing the staged backup archive.')),
                ...
                ('fresh_install_pkcs11_config_path', models.TextField(blank=True, default='', help_text='Optional provider PKCS#11 configuration file staged during the fresh-install wizard.')),
                ('fresh_install_pkcs11_config_env_var', models.CharField(blank=True, default='', help_text='Environment variable that points the PKCS#11 library to the provider configuration file.', max_length=128)),
