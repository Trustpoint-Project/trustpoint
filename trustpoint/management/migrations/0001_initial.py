...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_format', models.CharField(choices=[('0', 'dd/MM/yyyy HH:mm'), ('1', 'MM/dd/yyyy HH:mm'), ('2', 'dd MMM yyyy HH:mm'), ('3', 'dd MMM yyyy hh:mm a'), ('4', 'dd MMMM yyyy HH:mm:ss'), ('5', 'dd MMMM yyyy hh:mm:ss a'), ('6', 'yyyy-MM-dd HH:mm:ss'), ('7', "yyyy-MM-dd'T'HH:mm:ss")], default='6', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crypto_backend_audit_enabled', models.BooleanField(default=False, help_text='Record sanitized crypto backend operations in the audit log. Secrets, PINs, key material, payload bytes, and signatures are never stored.', verbose_name='Audit crypto backend operations')),
                ('last_updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crl_expiry_warning_days', models.PositiveIntegerField(default=7, help_text="Number of days before a CRL's expiration to trigger a 'CRL Expiring' warning.")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, default='', max_length=100, verbose_name='Organization Name')),
                ('organization', models.CharField(default='trustpoint', max_length=255, verbose_name='Organization (O)')),
                ('organization_unit', models.CharField(blank=True, default='', max_length=255, verbose_name='Organization Unit (OU)')),
                ('country', models.CharField(default='DE', max_length=2, verbose_name='Country (C)')),
                ('state', models.CharField(blank=True, default='', max_length=255, verbose_name='State/Province (ST)')),
                ('locality', models.CharField(blank=True, default='', max_length=255, verbose_name='Locality/City (L)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('security_mode', models.CharField(choices=[('0', 'Lab / Custom'), ('1', 'Brownfield Compatible'), ('2', 'Industrial Standard'), ('3', 'Hardened Production'), ('4', 'Critical Infrastructure')], default='1', max_length=6)),
                ...
                ('allow_imported_private_keys', models.BooleanField(default=False, help_text='Allow existing private-key credentials to be imported. Imported keys require PKCS#11-backed application-secret protection and are stored encrypted in the database.')),
                ('permitted_no_onboarding_pki_protocols', models.JSONField(blank=True, default=list, help_text='JSON list of allowed NoOnboardingPkiProtocol integer values (bitmask flags: CMP_SHARED_SECRET=1, EST_USERNAME_PASSWORD=4, MANUAL=16, REST_USERNAME_PASSWORD=32).')),
                ('permitted_onboarding_protocols', models.JSONField(blank=True, default=list, help_text='JSON list of allowed OnboardingProtocol integer values (MANUAL=0, CMP_IDEVID=1, CMP_SHARED_SECRET=2, EST_IDEVID=3, EST_USERNAME_PASSWORD=4, AOKI=5, BRSKI=6, OPC_GDS_PUSH=7, REST_USERNAME_PASSWORD=8).')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enabled', models.BooleanField(default=False, help_text='Use the configured SMTP server for outbound email.')),
                ...
                ('default_from_email', models.EmailField(default='no-reply.trustpoint@localhost', max_length=254)),
                ('last_updated', models.DateTimeField(auto_now=True)),
            ],
            options={
