...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(blank=True, default=2048, help_text='Minimum RSA key size in bits that certificates must meet. Set to null to disallow RSA entirely.', null=True),
        ),
