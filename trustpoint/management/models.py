...
class AppVersion(models.Model):
    """Model representing the version information of the application."""
    ...
    class Meta:
        """Model metadata: sets the singular verbose name for the app version."""
        verbose_name = 'App Version'

    def __str__(self) -> str:
        """Return a human-readable string with connection details for the app version."""
...
class BackupOptions(models.Model):
    ...
    class AuthMethod(models.TextChoices):
        """Available authentication methods for connecting to a backup host."""
    ...
    class Meta:
        """Model metadata: sets the singular verbose name for the admin."""
        verbose_name = 'Backup Option'

    def __str__(self) -> str:
        """Return a human-readable string with connection details for the backup option."""
