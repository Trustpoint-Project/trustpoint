...
class TestCmpUrls:
    ...
    def test_initialization_profile_url_resolves(self):
        ...
        url = reverse('cmp:req_domain_profile_op', 
    ...
    def test_initialization_url_resolves(self):
        ...
        url = reverse('cmp:req_domain_profile_or_op', kwargs={'domain': 'test_domain', 'cert_profile_or_operation': 'initialization'})
    ...
    def test_certification_url_resolves(self):
        ...
        url = reverse('cmp:req_domain_profile_or_op', kwargs={'domain': 'test_domain', 'cert_profile_or_operation': 'certification'})
    ...
    def test_certification_slash_url_resolves(self):
        ...
        url = reverse('cmp:req_domain_profile_or_op_slash', kwargs={'domain': 'test_domain', 'cert_profile_or_operation': 'certification'})
        assert url == '/.well-known/cmp/p/test_domain/certification/'
