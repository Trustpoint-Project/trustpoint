...
urlpatterns = [
    ...
    path('p/<str:domain>~<str:cert_profile>/<str:operation>', CmpRequestView.as_view(),
         name='req_domain_td_profile_op'),
    path('p/<str:domain>~<str:cert_profile>/<str:operation>/', CmpRequestView.as_view(),
    ...
    path('p/<str:domain>/<str:cert_profile_or_operation>/', CmpRequestView.as_view(),
         name='req_domain_profile_or_op_slash'),
    # 3 path segs, domain, profile, and operation specified in URL (/p/domain/profile/operation)
    path('p/<str:domain>/<str:cert_profile>/<str:operation>',
         CmpRequestView.as_view(),
         name='req_domain_profile_op'),
    path('p/<str:domain>/<str:cert_profile>/<str:operation>/',
         CmpRequestView.as_view(),
