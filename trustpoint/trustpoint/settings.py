...
TRUSTPOINT_OPERATIONAL_DATABASE = _env_value(
    'TRUSTPOINT_OPERATIONAL_DATABASE',
    _DEFAULT_OPERATIONAL_DATABASE,
).strip().lower()
TRUSTPOINT_LOCAL_SOFTWARE_BACKEND_NAME = _env_value(
...
DEFAULT_FROM_EMAIL = _env_value('DEFAULT_FROM_EMAIL', 'no-reply.trustpoint@localhost')
