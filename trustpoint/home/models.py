        ...
        def get_message(self) -> NotificationMessage:
            ...
            message_dict = {
                ...
                self.DEVICE_CERT_REVOKED: NotificationMessage(
                    ...
                    force_str(_('The device {device} has had its certificate revoked. The device may no longer be trusted.')),
                ),
                self.WEAK_SIGNATURE_ALGORITHM: NotificationMessage(
                    force_str(_('Certificate {common_name} uses a weak signature algorithm')),
                    force_str(_('The certificate {common_name} is signed using {signature_algorithm}, which is considered weak.')),
                ),
