        ...
        def get_message(self) -> NotificationMessage:
            ...
            message_dict = {
                ...
                self.ISSUING_CA_TEST: NotificationMessage(
                    force_str(_('Test for Issuing CA: {ca}')), force_str(_('Notification for Issuing CA: {ca}'))
                ),
                self.DOMAIN_TEST: NotificationMessage(
                    force_str(_('Test for Domain: {domain}')), force_str(_('Notification for Domain: {domain}'))
                ),
                ...
                self.DEVICE_TEST: NotificationMessage(
                    force_str(_('Test for Device: {device}')), force_str(_('Notification for Device: {device}'))
                ),
                # Welcome notifications
                ...
                self.WEAK_SIGNATURE_ALGORITHM: NotificationMessage(
                    ...
                    force_str(
                        _(
                            'The certificate {common_name} is signed using {signature_algorithm}, '
