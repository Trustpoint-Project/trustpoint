...
Rules:
- Paths must exist at compile time or runtime.
...
- Runtime type errors must be surfaced clearly and stop the workflow step.
...
- validate reference namespaces (`event`, `vars`)
- reject any unsupported syntax
