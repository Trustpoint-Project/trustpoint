    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregated_state', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Passed', 'Passed'), ('Rejected', 'Rejected'), ('Failed', 'Failed'), ('Finalized', 'Finalized'), ('NoMatch', 'NoMatch')], default='Pending', max_length=32)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['protocol', 'operation', 'ca_id', 'domain_id', 'device_id', 'fingerprint', 'template'], name='enrollment__protoco_ab5ce2_idx'), models.Index(fields=['aggregated_state'], name='enrollment__aggrega_7c0743_idx'), models.Index(fields=['finalized'], name='enrollment__finaliz_a5e5e1_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Running', 'Running'), ('AwaitingApproval', 'AwaitingApproval'), ('Approved', 'Approved'), ('Passed', 'Passed'), ('Finalized', 'Finalized'), ('Failed', 'Failed'), ('Rejected', 'Rejected')], default='Running', max_length=32)),
