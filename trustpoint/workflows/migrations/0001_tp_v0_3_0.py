    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregated_state', models.CharField(choices=[('AwaitingApproval', 'AwaitingApproval'), ('Approved', 'Approved'), ('Passed', 'Passed'), ('Rejected', 'Rejected'), ('Failed', 'Failed'), ('Finalized', 'Finalized'), ('NoMatch', 'NoMatch')], default='AwaitingApproval', max_length=32)),
