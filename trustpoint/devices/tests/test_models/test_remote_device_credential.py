...
def test_create_remote_device_credential_from_tls_client_credential(
        tls_client_credential_instance: dict[str, Any]) -> None:
    ...
    assert remote_download.device == device, (
...
@pytest.mark.django_db
def test_save_does_not_modify_existing_otp(
...
@pytest.mark.django_db
def test_check_otp_resets_on_max_attempts(
        remote_device_credential_download_instance: dict[str, Any]
) -> None:
...
@pytest.mark.django_db
def test_check_otp_creates_download_token(
        remote_device_credential_download_instance: dict[str, Any]
) -> None:
...
@pytest.mark.django_db
def test_get_otp_display_invalidated_otp(
        remote_device_credential_download_instance: dict[str, Any]
) -> None:
