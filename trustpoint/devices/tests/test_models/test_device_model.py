...
#from pki.tests.conftest import domain_instance, issuing_ca_instance

@pytest.mark.django_db
def test_no_onboarding_with_est_password(domain_instance):
    ...
    device = DeviceModel.objects.create(
        ...
        est_password="test_est_password",
    )
    ...
    assert device.est_password == "test_est_password"


@pytest.mark.django_db
def test_no_onboarding_with_cmp_shared_secret(domain_instance):
    ...
    device = DeviceModel.objects.create(
        ...
        cmp_shared_secret="test_cmp_secret",
    )
    ...
    assert device.cmp_shared_secret == "test_cmp_secret"


@pytest.mark.django_db
def test_est_onboarding_with_client_certificate(domain_instance):
...
@pytest.mark.django_db
def test_cmp_onboarding_with_client_certificate(domain_instance):
...
@pytest.mark.django_db
def test_generic_device_no_onboarding(domain_instance):
...
@pytest.mark.django_db
def test_device_opcua_gds(domain_instance):
...
@pytest.mark.django_db
def test_device_without_domain():
...
@pytest.mark.django_db
def test_device_creation_without_common_name(domain_instance):
