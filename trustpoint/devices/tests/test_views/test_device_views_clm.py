...
class TestCLMPostOperations:
    ...
    def test_clm_post_handles_form_submission(
        self,
        admin_client: Client,
...
class TestCredentialExpiration:
    ...
    def test_clm_view_has_credentials_context(
        self,
        admin_client: Client,
...
class TestCLMContextUrls:
    ...
    def test_clm_view_provides_main_url(
        self,
        admin_client: Client,
        device_instance: dict[str, Any]
    ) -> None:
...
class TestDeviceTableFiltering:
    ...
    def test_device_table_with_search_filter(
        self,
        admin_client: Client,
        device_instance: dict[str, Any]
    ) -> None:
...
class TestNoOnboardingCredentialSections:
    ...
    def test_sections_show_disabled_protocols(
        self,
        admin_client: Client,
        domain_instance: dict[str, Any]
    ) -> None:
...
class TestCLMViewWithoutDomain:
    ...
    def test_clm_view_device_without_domain_no_issue_urls(
        self,
        admin_client: Client
    ) -> None:
