...
class TestSaveCredentialToDbMixin:
    ...
    def test_save_credential_exception_handling(
        self, device_instance: dict[str, Any], monkeypatch: pytest.MonkeyPatch
    ) -> None:
        ...
        monkeypatch.setattr('pki.models.credential.CredentialModel.save_credential_serializer', mock_save_raises)

        # Should raise the exception
        with pytest.raises(RuntimeError, match='Database error'):
            issuer.issue_tls_client_credential(common_name='test', validity_days=365)

    def test_save_keyless_credential_with_existing_credential(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_save_keyless_credential_exception_handling(
        ...
        monkeypatch.setattr('pki.models.credential.CredentialModel.save_keyless_credential', mock_save_raises)
...
class TestCredentialSaver:
    ...
    def test_credential_saver_properties(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_credential_saver_save_keyless_credential(self, device_instance: dict[str, Any]) -> None:
        ...
        certificate = issuer._build_certificate(
            common_name='test-credential-saver', public_key=public_key, validity_days=365
        )
...
class TestBaseTlsCredentialIssuer:
    ...
    def test_raise_value_error(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_raise_type_error(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_pseudonym_and_domain_component_properties(self, device_instance: dict[str, Any]) -> None:
...
class TestTlsServerCredentialIssuer:
    ...
    def test_issue_tls_server_certificate_without_key(self, device_instance: dict[str, Any]) -> None:
...
class TestLocalDomainCredentialIssuer:
    ...
    def test_issue_domain_certificate_updates_onboarding_status(
        self, device_instance_onboarding: dict[str, Any]
    ) -> None:
...
class TestOpcUaServerCredentialIssuer:
    ...
    def test_validate_application_uri_empty_list(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_validate_application_uri_multiple_items(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_get_key_usage_for_rsa(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_get_key_usage_for_ecc(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_get_key_usage_unsupported_key_type(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_issue_opcua_server_credential_with_all_san_types(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_issue_opcua_server_certificate_without_key(self, device_instance: dict[str, Any]) -> None:
...
class TestOpcUaClientCredentialIssuer:
    ...
    def test_issue_opcua_client_credential_full(self, device_instance: dict[str, Any]) -> None:
        ...
        issued_credential = issuer.issue_opc_ua_client_credential(
            common_name='OPC UA Client Full Test', application_uri='urn:example:opcua:client', validity_days=365
        )

        assert issued_credential.common_name == 'OPC UA Client Full Test'
        assert (
            issued_credential.issued_credential_type
...
class TestBuildCertificateEdgeCases:
    ...
    def test_build_certificate_with_extra_extensions(self, device_instance: dict[str, Any]) -> None:
...
class TestCredentialPseudonymProperty:
    ...
    def test_tls_client_pseudonym(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_tls_server_pseudonym(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_domain_credential_pseudonym(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_opcua_server_pseudonym(self, device_instance: dict[str, Any]) -> None:
    ...
    def test_opcua_client_pseudonym(self, device_instance: dict[str, Any]) -> None:
