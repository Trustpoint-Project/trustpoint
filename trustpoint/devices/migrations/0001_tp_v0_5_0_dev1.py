    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('est_password', util.encrypted_fields.EncryptedCharField(blank=True, default='', max_length=345, verbose_name='EST Password')),
                ('cmp_shared_secret', util.encrypted_fields.EncryptedCharField(blank=True, default='', max_length=345, verbose_name='CMP Shared Secret')),
