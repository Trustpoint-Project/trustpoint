    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idempotency_released_key', models.CharField(blank=True, db_index=True, default='', max_length=128)),
                ('idempotency_released_at', models.DateTimeField(blank=True, null=True)),
                ('idempotency_released_by', models.CharField(blank=True, default='', max_length=150)),
                ('idempotency_release_reason', models.TextField(blank=True, default='')),
                ('idempotency_release_mode', models.CharField(blank=True, default='', max_length=16)),
                ('status', models.CharField(choices=[('queued', 'Queued'), ('running', 'Running'), ('awaiting', 'Awaiting'), ('paused', 'Paused'), ('finished', 'Finished'), ('approved', 'Approved'), ('error', 'Error'), ('timed_out', 'Timed out'), ('stopped', 'Stopped'), ('rejected', 'Rejected'), ('cancelled', 'Cancelled')], default='queued', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('queued', 'Queued'), ('running', 'Running'), ('awaiting', 'Awaiting'), ('paused', 'Paused'), ('finished', 'Finished'), ('approved', 'Approved'), ('error', 'Error'), ('timed_out', 'Timed out'), ('stopped', 'Stopped'), ('rejected', 'Rejected'), ('cancelled', 'Cancelled')], default='queued', max_length=16)),
                ('status_reason', models.CharField(blank=True, default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('status__in', ('queued', 'running'))), fields=('instance',), name='wf2_job_one_active_per_instance')],
            },
        ),
        migrations.AddIndex(
