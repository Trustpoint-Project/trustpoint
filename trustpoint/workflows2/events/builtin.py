...
def register_builtin_events() -> None:
    ...
    reg.register_many(
        [
            ...
            EventSpec(
                key=Triggers.CMP_INITIALIZATION,
                title=_('CMP initialization'),
                description=_('CMP initialization request received.'),
                group='cmp_requests',
                group_title='CMP',
            ...
            EventSpec(
                ...
                title=_('CMP certification'),
                description=_('CMP certification request received.'),
                group='cmp_requests',
                group_title='CMP',
