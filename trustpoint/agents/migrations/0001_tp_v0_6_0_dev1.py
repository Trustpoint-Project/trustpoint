    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capabilities', models.JSONField(blank=True, default=list, help_text='List of job types this agent supports, e.g. ["wbm_cert_push"]. Used for display and validation; does not restrict API access at runtime.', verbose_name='Capabilities')),
