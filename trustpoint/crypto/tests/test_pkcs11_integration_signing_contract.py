...
SCENARIOS = (
    SigningScenario(
        name="rsa_pkcs1v15_sha256_COMPLETE_BACKEND",
    ...
    SigningScenario(
        name="rsa_pkcs1v15_sha256_ALLOW_APPLICATION_HASH",
        key_spec=RsaKeySpec(key_size=2048),
        sign_request=SignRequest.rsa_pkcs1v15_sha256(),
    ...
    SigningScenario(
        name="ecdsa_p256_sha256_COMPLETE_BACKEND",
    ...
    SigningScenario(
        name="ecdsa_p256_sha256_ALLOW_APPLICATION_HASH",
        key_spec=EcKeySpec(curve=EllipticCurveName.SECP256R1),
        sign_request=SignRequest.ecdsa_sha256(),
        signing_execution_mode=SigningExecutionMode.ALLOW_APPLICATION_HASH,
